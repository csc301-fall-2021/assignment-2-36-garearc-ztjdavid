...
import com.csc301group36.Covid19API.Entities.TimeFormatError;
...
public class DateUtils {
    public Date stringToDate(String date, DBType dbType) throws RequestError {
        try{
            ...
            throw new RequestError("We found a date time with invalid format: " + date);
        }
    }
